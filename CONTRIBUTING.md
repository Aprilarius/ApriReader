...
Before changing product behavior, read the product and UI specifications,
architecture, dependency policy, and roadmap.
...
- Do not add protected Steamworks files, telemetry, bundled catalogs, speech
  models, or generated covers to the public repository.
